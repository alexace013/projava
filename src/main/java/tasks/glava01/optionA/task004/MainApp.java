...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(LogicActions.isPasswordEqualsApp(LogicActions.SAVE_PASSWORD));
        System.out.println(LogicActions.isPasswordEqualsApp(LogicActions.SAVE_PASSWORD + "1"));
    }
}